...
const submit = () => {
    if (props.moneda_principal.id != form.moneda_seleccionada_id) {
        if (form.tipo_cambio_id != 0) {
...
<template>
    ...
    <BreezeAuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight">Nuevo Trabajo</h2>
        </template>
        <div class="py-12">
